...
const char *TACSKSStochasticFFMeanFunction::funcName = "TACSKSStochasticFFMeanFunction";
  ...
  for (int j = 0; j < nsterms; j++){
    ...
    for (int q = 0; q < nqpts; q++){
...

      {
        ...
        const int numDisps = delem->numVariables();
        const int numNodes = delem->numNodes();
